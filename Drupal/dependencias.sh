...
apt-get install mailutils git php php-cli php-common libapache2-mod-php php-curl php-dev php-imap php-json php-ldap php-pgsql php-snmp php-xml php-gd apache2 curl php-fpm php-pdo php-zip php-mbstring php-pear php-bcmath gnupg2 -y
